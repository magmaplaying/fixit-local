    ...
    <div>
      ...
      <section className="bg-espresso text-background">
        <div className="mx-auto max-w-4xl px-4 py-20 sm:py-28">
          <p className="font-mono text-xs uppercase tracking-[0.22em] text-cobble-300">За майстори и специалисти</p>
          <h1 className="mt-5 max-w-2xl font-display text-4xl font-semibold leading-tight sm:text-6xl">
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        <div className="grid gap-6 sm:grid-cols-2">
          {BENEFITS.map((b) => (
            <div key={b.title} className="rounded-2xl border border-black/5 bg-white p-6">
        ...
        <h2 className="mt-16 font-display text-2xl font-semibold tracking-tight">Как да започнете</h2>

...
/**
 * "Издигни" button. Calls the server action, then navigates client-side to the
 * returned Stripe Checkout URL — an in-action redirect to an external URL
